...
public class SecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    @Value("${authentication.allow.cors:http://localhost:3000,http://localhost:4200, http://103.170.123.231:3000}")
    ...
    protected void configure(HttpSecurity http) throws Exception {
        ...
        httpSecurity.authorizeRequests()
                ...
                .antMatchers("/v1/maintenance/list/status").hasAnyAuthority(PermissionType.MAINTENANCE_MANAGEMENT.getCode(), PermissionType.FULL_PERMISSION.getCode())
                
                .antMatchers("/v1/evaluation/detail").hasAnyAuthority(PermissionType.EVALUATION_MANAGEMENT.getCode(), PermissionType.FULL_PERMISSION.getCode(), PermissionType.CONFIRM_MAINTENANCE.getCode())
