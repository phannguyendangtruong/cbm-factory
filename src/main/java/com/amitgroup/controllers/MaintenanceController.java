...
public class MaintenanceController {
    ...
    public BasePaginationResponse getAllMaintenance(@RequestBody SearchMaintenance maintenance, HttpServletRequest request) {
        Pageable pageable = PageRequest.of(maintenance.getPageIndex(), maintenance.getPageSize());
        return maintenanceService.getAllMaintenance(pageable, request);
    }
